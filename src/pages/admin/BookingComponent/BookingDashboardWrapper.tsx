...
const BookingDashboardWrapper: React.FC<BookingDashboardWrapperProps> = ({ isEditMode = false }) => {
  ...
  return (
    <div className="h-full overflow-y-auto py-6" style={{ maxHeight: "calc(100vh - 64px)" }}>
      <div className="px-4">
        {isLoading ? (
