          ...
          <div className="mb-6 p-4 border border-gray-200 rounded-lg">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                {selectedLocation === "google_meet" && <Video className="h-5 w-5 text-gray-400 mr-2" />}
                {selectedLocation === "zoom"         && <Video className="h-5 w-5 text-gray-400 mr-2" />}
                {selectedLocation === "teams" && <Video className="h-5 w-5 text-gray-400 mr-2" />}
                {selectedLocation === "in_person"    && <MapPin className="h-5 w-5 text-gray-400 mr-2" />}
                <p className="ml-2">
                  {{
